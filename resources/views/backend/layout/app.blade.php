...
{{--    Text Editor--}}
    <link rel="stylesheet" href="{{ asset('assets/backend/libs/text-editor/quill.snow.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/backend/libs/text-editor/katex.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/backend/libs/text-editor/quill.bubble.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/backend/libs/text-editor/monokai-sublime.min.css') }}">
...
{{--Text Editro--}}
{{--<script src="{{ asset('assets/backend/libs/text-editor/quill.js') }}"></script>--}}
{{--<script src="{{ asset('assets/backend/libs/text-editor/highlight.min.js') }}"></script>--}}
{{--<script src="{{ asset('assets/backend/libs/text-editor/katex.min.js') }}"></script>--}}
