        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row" action="{{ route('admin.team-member.update',$member->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ $member->position ?? old('position') }}"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" value="{{ $member->fb_url }}" name="fb_url" class="form-control" placeholder="FB URL">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="mdi mdi-youtube"></i></div>
                                                    <input type="text" value="{{ $member->youtube_url }}" name="youtube_url" class="form-control" placeholder="Youtube URL">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="mdi mdi-instagram"></i></div>
                                                    <input type="text" value="{{ $member->insta_url }}" name="insta_url" class="form-control" placeholder="Instagram URL">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label for="image" class="d-block">
                                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                                <div class="">
                                                    <img class="image img-fluid" src="{{ asset($member->image) }}">
                                                    <input type="file"
                                                           id="image"
