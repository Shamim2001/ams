        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.quiz.store') }}" method="post" class="row" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="mb-2">
                                                ...
                                                <textarea name="video" class="form-control @error('video') is-invalid @enderror" rows="3">{!! old('video') !!}</textarea>
                                                @error('video')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
