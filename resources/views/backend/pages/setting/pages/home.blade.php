        ...
        <div class="card-body">
            <form action="{{ route('admin.setting.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <label for="about_bg_banner" class="d-block">
                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                <div class="">
                                    <img class="about_bg_banner img-fluid" src="{{ asset(setting('about_bg_banner')) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="about_slider_before_banner" class="d-block">
                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                <div class="">
                                    <img class="about_slider_before_banner img-fluid" src="{{ asset(setting('about_slider_before_banner')) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="about_slider_after_banner" class="d-block">
                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                <div class="">
                                    <img class="about_slider_after_banner img-fluid" src="{{ asset(setting('about_slider_after_banner')) }}">
                ...
                <div class="my-3">
                    ...
                    <input type="text" name="about_title" value="{{ setting('about_title')  }}" class="form-control" id="" placeholder="About Title" required>
                </div>
                <div class="my-3">
                    <label for="">Description <span class="fw-bolder text-danger">*</span></label>
                    <input type="hidden" name="types[]" value="about_description">
                    <textarea name="about_description" id="" class="form-control"  rows="5">{!! setting('about_description') !!}</textarea>
                </div>
