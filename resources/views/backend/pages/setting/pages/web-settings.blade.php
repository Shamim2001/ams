        ...
        <div class="card-body">
            <form action="{{ route('admin.setting.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <label for="website_favicon" class="d-block">
                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                <div class="">
                                    <img class="website_favicon img-fluid" src="{{ asset(setting('website_favicon')) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="website_logo" class="d-block">
                            <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                <div class="">
                                    <img class="website_logo img-fluid" src="{{ asset(setting('website_logo')) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="website_name" value="{{ setting('website_name')  }}" class="form-control" id="" placeholder="Website Name" required>
                </div>

                <div class="mb-3">
                    <label for=""> Website About <span class="fw-bolder text-danger">*</span></label>
                    <input type="hidden" name="types[]" value="website_about">
                    <input type="text" name="website_about" value="{{ setting('website_about')  }}" class="form-control" id="" placeholder="Website About" required>
                </div>
               ...
               <div class="my-3">
                   <h4>Open Hours</h4>
                       <div class="mb-3">
                           ...
                           <textarea name="f_open_hours" id="" class="form-control" rows="2">{!! nl2br(setting('f_open_hours'))  !!}</textarea>
                       </div>
               </div>
                <div class="my-3">
                   <h4>Social Link</h4>
                   <div class="row">
                       <div class="col-md-6">
                           <div class="mb-3">
                               ...
                               <input type="url" name="f_fb_url" value="{{ setting('f_fb_url')  }}" class="form-control" id="" placeholder="Facebook Url" required>
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="mb-3">
                               ...
                               <input type="url" name="f_youtube_url" value="{{ setting('f_youtube_url')  }}" class="form-control" id="" placeholder="Youtube Url" required>
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="mb-3">
                               ...
                               <input type="url" name="f_linkedin_url" value="{{ setting('f_linkedin_url')  }}" class="form-control" id="" placeholder="Linkedin Url" required>
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="mb-3">
                               ...
                               <input type="url" name="f_instagram_url" value="{{ setting('f_instagram_url')  }}" class="form-control" id="" placeholder="Instagram Url" required>
                           </div>
                       </div>
                   </div>
               </div>
                <div class="my-3">
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea name="f_location" id="" class="form-control" rows="2">{!! nl2br(setting('f_location'))  !!}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for=""> Phone Number <span class="fw-bolder text-danger">*</span></label>
                            <input type="hidden" name="types[]" value="f_phone">
                            <textarea name="f_phone" id="" class="form-control" rows="2">{!! nl2br(setting('f_phone'))  !!}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for=""> Email Address <span class="fw-bolder text-danger">*</span></label>
                            <input type="hidden" name="types[]" value="f_email">
                            <textarea name="f_email" id="" class="form-control" rows="2">{!! nl2br(setting('f_email'))  !!}</textarea>
                        </div>
