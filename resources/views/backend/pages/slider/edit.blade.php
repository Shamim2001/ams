        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.slider.update',$slider->id) }}" method="post" class="row" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="title"
                                                      ...
                                                      rows="2">{!! $slider->title ?? old('title') !!}</textarea>
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="title_two"
                                                      class="form-control @error('title') is-invalid @enderror"
                                                      rows="2">{!! $slider->title_two ?? old('title_two') !!}</textarea>
                                            @error('title')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description"
                                                      ...
                                                      rows="2">{!!$slider->description ?? old('description')!!}</textarea>
                                            @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="border-secondary rounded p-2 d-flex justify-content-center align-items-center" style="border:1px dashed">
                                            <div class="">
                                                <img class="img-fluid" src="{{ asset($slider->image) }}" id="showImage" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
