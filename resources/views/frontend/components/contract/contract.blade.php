                ...
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="m-0 p-0 fs-16">
                            <a class="text-muted" href="mailto:{{ setting('get_office_address')  }}">{{ setting('get_mail_address')  }}</a>
                        </p>
                     </div>
                </div>
            </div>
                ...
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="fs-16 m-0 p-0">
                            <a class="text-muted" href="tel:{{ setting('get_office_address')  }}">{{ setting('get_telephone_number')  }}</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="text-muted fs-16">{{ setting('get_office_address')  }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-8 mx-auto">
                        <div class="custom-form mt-4 mt-lg-0">
                            <form action="{{ route('contract-message.store') }}" method="POST">
                                @csrf
                                <p id="error-msg"></p>
                                <div class="row">
                                    <div class="col-lg-4">
