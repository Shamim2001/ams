        ...
        <rs-module id="rev_slider_1_1" data-version="6.5.7">
            <rs-slides>
                    ...
                    <rs-layer
                        ...
                        style="z-index:8;"
                    ><img src="{{asset('/')}}assets/frontend/images/slider/home1/bg-slider-shape1.png" alt="bg-slider-shape1" class="tp-rs-img" width="2600" height="309" data-no-retina>                        </rs-layer>
                    ...
                    <rs-layer
                        ...
                        style="z-index:9;"
                    ><img src="{{asset('/')}}assets/frontend/images/slider/home1/slider-star1.png" alt="slider-star1" class="tp-rs-img" width="138" height="118" data-no-retina>                        </rs-layer>
                </rs-slide>

                @foreach($sliders as $key => $slider)
                    <rs-slide style="position: absolute;" data-key="rs-{{ $key + 1}}" data-title="Slide" data-thumb="{{$slider->image ? asset($slider->image) : asset('assets/frontend/bg-slider3-50x100.jpg')}}" data-anim="ms:1000;r:0;" data-in="o:0;" data-out="a:false;">
                    <img src="{{ $slider->image ? asset($slider->image) : asset('assets/frontend/images/slider/home1/bg-slider3.jpg')}}" title="bg-slider3" width="1920" height="680" class="rev-slidebg tp-rs-img" data-panzoom="d:10000;ss:115%;se:100;" data-no-retina>
                    ...
                    >
                        ...
                        data-frame_999="o:0;st:w;sR:4600;"
                        style="z-index:11;font-family:'Poppins';"
                    >  {!! nl2br($slider->title_two ?? "") !!} </rs-layer>
                        ...
                        >{{$slider->description}}</rs-layer>

                         <a
                               id="slider-1-slide-3-layer-7"
                               class="rs-layer"
                               href="{{ $slider->url }}" target="_self" rel="nofollow"
                               data-type="text"
                               data-color="#2b2b2b"
                               data-xy="x:c;y:b;"
                           ...
                           >{{--<span class="btn btn-plus icon-right">Our Services<i class="flaticon flaticon-gear icon-abs"></i></span>--}}
                         </a>
                    </rs-group>
