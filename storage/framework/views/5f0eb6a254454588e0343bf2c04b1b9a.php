    ...
    <section class="section bg-light" style="padding: 50px 0">
        <div class="container">
                ...
                <div class="member-detail md">
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($key==0): ?>
                        <div class="content">
                            <div class="img-part">
                                <img src="<?php echo e($member->image ? asset($member->image) : asset('assets/frontend/images/home1/team-1.jpg')); ?>" style="height:600px;" alt="">
                            </div>
                            <div class="text-part">
                                <h2 class="name"><?php echo e($member->name ?? ""); ?></h2>
                                <div class="designation"><?php echo e($member->position ?? ""); ?></div>
                                <hr>
            ...
            <div class="row" style="margin-top: 100px">
                <div class="member-detail desktop" style="display: flex">
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($key!=0): ?>
                        <div class="director col-md-4">
                            <div class="img-part">
                ...
                <div class="member-detail mobile">
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($key!=0): ?>
                        <div class="director col-md-4">
                            <div class="img-part">
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thechemicals\resources\views/frontend/pages/leadership-team/leadership-team.blade.php ENDPATH**/ ?>