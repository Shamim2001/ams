            ...
            <!--<a href="index.html" class="bixol-header-logo"><img src="<?php echo e(asset('assets/frontend/')); ?>/images/logo.png" alt=""></a>-->
                <nav class="desktop-menu">
                    <ul>
                        ...
                        <li class="has-submenu"><a href="#">Our Customer</a>
                        <li class="has-submenu"><a href="#">We Represent</a>
                        <li class="has-submenu"><a href="#">Link & Resources</a>
                        <li class="has-submenu"><a href="#">Contact</a></li>
                    </ul>
                </nav>
            </div>
...
<div class="bixol-mobile-menu">
    ...
    <ul>
        <li class="has-submenu"><a href="/">Home</a></li>
        <li class="has-submenu"><a href="#">Products</a></li>
        <li class="has-submenu"><a href="#">Markets</a></li>
...
<?php /**PATH G:\Milon Kumar Tailwind Css\Laravel\Camical\chemical\resources\views/frontend/includes/header.blade.php ENDPATH**/ ?>