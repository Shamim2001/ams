        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="<?php echo e(auth()->user()->image ? asset(auth()->user()->image) : defaultImage(auth()->user()->name)); ?>"
                         alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="Javascript:void(0)"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile" class="text-uppercase"><?php echo e(auth()->user()->type); ?></span></a>
...
<?php /**PATH G:\Milon Kumar Tailwind Css\Laravel\Camical\chemical\resources\views/backend/includes/header.blade.php ENDPATH**/ ?>