...
<div class="container">
    <div class="content">
        <h3 class="title">
           Why The Chemicals Ltd.?
            <span class="badge bg-info">The Chemicals Ltd. is a preferred choice for pharmaceutical indenting due to several key factors:</span>
        </h3>
...
<div class="row row-cols-1 row-cols-md-3 g-4 row justify-content-center">
    ...
    <div class="col-5">
      <div class="card">
        <!--  <img src="<?php echo e(('assets/frontend/industry_expertise.png')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
        <!---->
        <div class="card-body">
    ...
    <div class="col-5">
      <div class="card">
       <!--   <img src="<?php echo e(('assets/frontend/wide_network.png')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
       <!---->
        <div class="card-body">
...
<br>
    ...
    <div class="col-5">
      <div class="card">
        <!--  <img src="<?php echo e(('assets/frontend/Reliability.jpeg')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
    ...
    <div class="col-5">
      <div class="card">
        <!--  <img src="<?php echo e(('assets/frontend/q_assurance.jpg')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
        <!---->
        <div class="card-body">
...
<br>
    <div class="col-5">
      <div class="card">
      <!--<img src="<?php echo e(('assets/frontend/centric_approach.jpg')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
      <!--  -->
        <div class="card-body">
    ...
    <div class="col-5">
      <div class="card">
        <!--  <img src="<?php echo e(('assets/frontend/transparency_integrity.jpg')); ?>"  style="width: 600px; height: 400px;" alt="...">-->
        <!---->
        <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-7 row justify-content-end">
            <div class="card" style="width: 38rem;">
                ...
                <img src="<?php echo e(('assets/frontend/deffernt.jpg')); ?>"  style="width: 600px; height: 500px;" alt="...">
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\thechemicals\resources\views/frontend/pages/why-the-chemical/why-the-chemical.blade.php ENDPATH**/ ?>