        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row" action="<?php echo e(route('admin.supplier.store')); ?>" method="post"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select id="cars" class="form-control" name="country" id="countrjy">
...
<?php echo $__env->make('backend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\chemical\resources\views/backend/pages/supplier/create.blade.php ENDPATH**/ ?>